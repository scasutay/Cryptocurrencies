...
fun CurrencyDetailScreen(
    ...
    if (state.isLoading) {
        ...
        Column(
            ...
            AnimatedVisibility(
                visible = currency.currencyPriceHistory.isNotEmpty()
            ) {
                ...
                val startIndex = (currency.currencyPriceHistory.lastIndex - amountOfVisibleDataPoints)
                    .coerceAtLeast(0)
                LineChart(
                    dataPoints = currency.currencyPriceHistory,
                    style = ChartStyle(
                    ...
                    visibleDataPointsIndices = startIndex..currency.currencyPriceHistory.lastIndex,
                    unit = "$",
                    modifier = Modifier
                        .fillMaxWidth()
                        .aspectRatio(16 / 9f)
